...
function processChangelog(changelog, versionSuffix, versionOverride) {
    ...
    const todaysDate = (0, moment_1.default)().format("YYYY-MM-DD");
...
function hasActualChanges(content) {
    return content.includes("*") && !(content.includes("* None\n") || content.includes("* None.\n"));
}
function getNextVersion(prevVersion, sectionName) {
    switch (sectionName) {
        case "Fixed":
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield (0, helpers_1.updateChangelogContent)(changelogPath, versionSuffix, versionOverride);
